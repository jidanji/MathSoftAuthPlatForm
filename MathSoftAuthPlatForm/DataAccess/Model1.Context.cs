...
namespace DataAccess
{
    ...
    public partial class MathSoftAuthPlatFormEntities : DbContext
    {
        public MathSoftAuthPlatFormEntities()
            : base("name=MathSoftAuthPlatFormEntities")
        {
        }
        ...
        public virtual DbSet<AttachedMent> AttachedMent { get; set; }
        public virtual DbSet<BaseInfo> BaseInfo { get; set; }
        public virtual DbSet<BrowserInfo> BrowserInfo { get; set; }
        ...
        public virtual DbSet<ZhanZhangStaticNew> ZhanZhangStaticNew { get; set; }
