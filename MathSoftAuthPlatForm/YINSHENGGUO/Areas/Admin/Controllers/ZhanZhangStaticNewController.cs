...
namespace MAZIKONG.Areas.Admin.Controllers
{
    public class ZhanZhangStaticNewController : Controller
    {
        ...
        [Authorize]
        public ActionResult GetData(int draw,int start,int length,string ispipei,string ZhanZhangDaQu, string studentInfo)
        {
        ...
        [Authorize]
        public ActionResult GetExcel(string ispipei,string ZhanZhangDaQu, string studentInfo)
        {
