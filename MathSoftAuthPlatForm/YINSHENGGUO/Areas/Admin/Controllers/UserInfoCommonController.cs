...
{
    public class UserInfoCommonController : AdminBaseController
    {
        [PreLoadMenuList]
        [Authorize]
            ...
            string UserPhone)
        {
            ...
            int total = 0;
            List<Math_UserInfo> list = bLL_Role.SearchComon(start, length, out total, where1.And(where2).And(where3).And(where4));
