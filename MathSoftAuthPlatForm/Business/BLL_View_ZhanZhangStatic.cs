...
namespace Business
{
 public   class BLL_View_ZhanZhangStatic: BaseMathRoleAuthorEntities
    {
        private DbSet<View_ZhanZhangStatic> contextItem = null;
        public BLL_View_ZhanZhangStatic():base()
        {
        ...
        public List<View_ZhanZhangStatic> Search(int PageIndex, int PageSize, out int total, Expression<Func<View_ZhanZhangStatic, bool>> where = null)
        {
            ...
            IQueryable<View_ZhanZhangStatic> lazyList = contextItem.Where(exp1).OrderByDescending(i => i.XSCId);
