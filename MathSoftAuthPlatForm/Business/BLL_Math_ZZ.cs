...
namespace Business
{
    public class BLL_Math_ZZ: BaseMathRoleAuthorEntities
    {
        private DbSet<Math_ZZ> contextItem = null;
        public BLL_Math_ZZ():base()
        {
        ...
        public UIModelData<Math_ZZ> Add(string zhanzhang, string zhanzhangdaqu, string zhanzhangquyu, Expression<Func<Math_ZZ, bool>> perWhere)
        {
        ...
        public List<Math_ZZ> Search(int PageIndex, int PageSize, out int total, Expression<Func<Math_ZZ, bool>> where = null)
        {
            ...
            IQueryable<Math_ZZ> lazyList = contextItem.Where(exp1);
