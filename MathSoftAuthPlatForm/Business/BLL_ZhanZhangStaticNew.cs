...
namespace Business
{
    public class BLL_ZhanZhangStaticNew: BaseMathRoleAuthorEntities
    {
        
        private DbSet<ZhanZhangStaticNew> contextItem = null;
        public BLL_ZhanZhangStaticNew() : base()
        {
        ...
        public List<ZhanZhangStaticNew> Search(int PageIndex, int PageSize, out int total, Expression<Func<ZhanZhangStaticNew, bool>> where = null)
        {
            ...
            IQueryable<ZhanZhangStaticNew> lazyList = contextItem.Where(exp1).OrderByDescending(i => i.XSCId);
